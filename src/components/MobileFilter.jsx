            ...
            </div>
            {
                openFilter ? <div className='bg-gray-100 p-2 md:hidden'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="range" min="0" max="10000" name="" id="" value={priceRange[1]} onChange={(e) => setPriceRange([priceRange[0], Number(e.target.value)])} className='transition-all w-[200px]' />
                    </div>
                    <button className='bg-red-500 text-white rounded-md px-3 py-1 mt-5 cursor-pointer'
                        onClick={() => { setSearch(''); setCategory('All'); setBrand('All'); setPriceRange([0, 10000]); setOpenFilter(false) }}
